...
# into docs/milestones/F2_figures.md). Worst clean value over the
# corpus: 0.0887x of this ceiling.
#
...
# is `counter_headroom_room`, generated beside them. The margin is eaten from
# BOTH sides -- a harder corpus entry raises the minimum edge and loosens this,
# but a formulation change that IMPROVES sensitivity anywhere lowers it and
# tightens it -- and the published room absorbs that while still catching every
# order-of-magnitude raise. The demonstration that it catches one is a shipped
# test.
#
