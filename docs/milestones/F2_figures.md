...
| `rigid_mode_residual_worst_over_corpus` | 1.1410e-16 |
| `rigid_mode_smallest_decided` | 2.0502e+02 |
| `rigid_mode_seventh_orders_smallest_decided` | 1.312 |
| `rigid_mode_largest_refused` | 1.8800e+02 |
| `rigid_mode_largest_rigid_eigenvalue` | 1.2727 |
| `rigid_mode_corpus_frames` | 114 |
| `rigid_mode_corpus_refused` | 29 of 114 |
| `retired_ratio_over_ceiling_on_corpus` | 80 of 114 |
