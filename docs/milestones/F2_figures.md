...
| `rigid_mode_mechanism_cell` | 27 units x 42 spans, subdiv 1 |
| `rigid_mode_mechanism_count` | 432 |
...
| `rigid_mode_corpus_frames` | 172 |
| `rigid_mode_corpus_refused` | 38 of 172 |
| `rigid_mode_corpus_decided_clear` | 129 |
| `rigid_mode_corpus_refused_clear` | 30 |
...
| `retired_ratio_over_ceiling_on_corpus` | 119 of 172 |
| `retired_loss_over_ceiling_on_corpus` | 130 of 172 |
